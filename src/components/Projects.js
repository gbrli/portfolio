            ...
            <ul className="project-list">
                ...
                <a href="https://giuliabroli.netlify.app" className="secondary-link" target="_blank" rel="noreferrer"><img className="project-images" src={portfolio} alt="project screenshot"></img></a>                    
                    <article>
                        ...
                        <p><a href="https://github.com/stungmoon/portfolio" className="secondary-link" target="_blank" rel="noreferrer">Link to Source Code</a></p>
                    </article>
                </li>
                ...
                <a href="https://pokedice.netlify.app" className="secondary-link" target="_blank" rel="noreferrer"><img className="project-images" src={pokedice} alt="project screenshot"></img></a>
                    <article>
                        ...
                        <p><a href="https://pokedice.netlify.app" className="secondary-link" target="_blank" rel="noreferrer">Link to Project</a></p>
                        <p><a href="https://github.com/stungmoon/Pokemon-Dice-Fight" className="secondary-link" target="_blank" rel="noreferrer">Link to Source Code</a></p>
                    </article>                
                </li>
                <div className="separator"></div>
                <li>
                    ...
                    <article>
                        ...
                        <p><a href="https://sonnet-sorter.netlify.app" className="secondary-link" target="_blank" rel="noreferrer">Link to Project</a></p>
                        <p><a href="https://github.com/stungmoon/Shakespeare-Sonnet-Sorter" className="secondary-link" target="_blank" rel="noreferrer">Link to Source Code</a></p>
                    </article>                
                </li>
          </ul>
        </section>

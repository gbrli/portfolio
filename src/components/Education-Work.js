    ...
    return (
        <section className="education-work-wrapper">
          <section id="education" className="education">
            ...
            <p><span className="current">Currently studying: </span>Full Stack Open 2022</p>
            <p><span className="current">Currently studying: </span>Colt Steele: Javascript Algorithm and Data Structures Masterclass</p>
            ...
            <p>Bachelor's in Cultural Mediation, Translation and Interpreting (Italian, English, French)</p>
          </section>
          <section id="work-history" className="work-history">
            <h2>Work History</h2>
            <p className="date">2020-2021</p>
